...
router.post('/:id/void', authorize('sales', 'edit'), salesController.voidSale);
router.delete('/:id', authorize('sales', 'edit'), salesController.remove);
...
router.delete('/:saleId/products/ticket/:id', authorize('sales', 'edit'), productsController.deleteTicket);
...
router.delete('/:saleId/products/hotel/:id', authorize('sales', 'edit'), productsController.deleteHotel);
...
router.delete('/:saleId/products/insurance/:id', authorize('sales', 'edit'), productsController.deleteInsurance);
...
router.delete('/:saleId/products/plan/:id', authorize('sales', 'edit'), productsController.deletePlan);
...
router.delete('/:saleId/products/checkin/:id', authorize('sales', 'edit'), productsController.deleteCheckin);
...
router.delete('/:saleId/products/migration/:id', authorize('sales', 'edit'), productsController.deleteMigration);
...
router.delete('/:saleId/products/simcard/:id', authorize('sales', 'edit'), productsController.deleteSimcard);
...
router.delete('/:saleId/products/baggage/:id', authorize('sales', 'edit'), productsController.deleteBaggage);
...
router.delete('/:saleId/products/car-rental/:id', authorize('sales', 'edit'), productsController.deleteCarRental);
...
router.delete('/:saleId/products/finca/:id', authorize('sales', 'edit'), productsController.deleteFinca);
...
router.delete('/:saleId/products/tour/:id', authorize('sales', 'edit'), productsController.deleteTour);
...
router.delete('/:saleId/products/convention/:id', authorize('sales', 'edit'), productsController.deleteConvention);
...
router.delete('/:saleId/products/restaurant/:id', authorize('sales', 'edit'), productsController.deleteRestaurant);
...
router.delete('/:saleId/products/visa/:id', authorize('sales', 'edit'), productsController.deleteVisa);
...
router.delete('/:saleId/products/passport/:id', authorize('sales', 'edit'), productsController.deletePassport);
...
router.delete('/:saleId/products/pet-service/:id', authorize('sales', 'edit'), productsController.deletePetService);
