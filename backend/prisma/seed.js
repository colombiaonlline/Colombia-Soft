...
async function main() {
  ...
  const aeropuertosData = [
    ...
    { nombre: 'Alfonso Bonilla Aragón', codigoIata: 'CLO', ciudad: 'Cali', pais: 'Colombia', tipo: 'Nacional' },
    { nombre: 'Gustavo Rojas Pinilla', codigoIata: 'ADZ', ciudad: 'San Andrés', pais: 'Colombia', tipo: 'Nacional' },
    { nombre: 'Ernesto Cortissoz', codigoIata: 'BAQ', ciudad: 'Barranquilla', pais: 'Colombia', tipo: 'Nacional' },
    { nombre: 'Matecaña', codigoIata: 'PEI', ciudad: 'Pereira', pais: 'Colombia', tipo: 'Nacional' },
    { nombre: 'Palonegro', codigoIata: 'BGA', ciudad: 'Bucaramanga', pais: 'Colombia', tipo: 'Nacional' },
  ...
  const equipajeData = [
    { aerolineaId: aerolineasMap['AV'].id, tipoTarifa: 'Económica', articuloPersonal: '1 bolso personal (40x30x20 cm)', equipajeMano: '1 maleta de mano (55x40x20 cm) hasta 10kg', equipajeBodega: 'No incluido' },
    { aerolineaId: aerolineasMap['AV'].id, tipoTarifa: 'Ejecutiva', articuloPersonal: '1 bolso personal', equipajeMano: '1 maleta de mano hasta 14kg', equipajeBodega: '2 maletas hasta 32kg c/u' },
    { aerolineaId: aerolineasMap['LA'].id, tipoTarifa: 'Economy', articuloPersonal: '1 bolso personal', equipajeMano: '1 maleta de mano hasta 8kg', equipajeBodega: 'No incluido' },
    { aerolineaId: aerolineasMap['LA'].id, tipoTarifa: 'Premium', articuloPersonal: '1 bolso personal', equipajeMano: '1 maleta de mano hasta 12kg', equipajeBodega: '1 maleta hasta 23kg' },
  ];
  const equipajeMap = {};
